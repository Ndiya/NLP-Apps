...
# load in the data.
df_list = []
cities = ['Markham', 'Mississauga', 'toronto', 'boston']
...
msk = df['city'] == 'Markham'
df.loc[msk, 'city'] = 'Markham'

msk = df['city'] == 'Mississauga'
df.loc[msk, 'city'] = 'Mississauga'

msk = df['city'] == 'toronto'
df.loc[msk, 'city'] = 'toronto'

msk = df['city'] == 'boston'
df.loc[msk, 'city'] = 'boston'
...
df['job_description'].iloc[:12].apply(word_tokenize)
...
app.layout = html.Div(style={'backgroundColor': colors['background']}, children=[
    html.H1(
        children='In-Demand Skills for Data Scientists with NLTK',
        style={
            'textAlign': 'center',
            'color': colors['text']
        }
    ...
    html.Div(children='A web application framework for NLP.', style={
        'textAlign': 'center',
        'color': colors['text']
    }),
